...
inline void isExtensionSupported(const std::string& fname)
{
    ...
    if (openvdb::string::ends_with(fname, ".ppm")) return;
    else if (openvdb::string::ends_with(fname, ".exr"))
    {
    ...
    else if (openvdb::string::ends_with(fname, ".png"))
    {
...
render(const GridType& grid, const std::string& imgFilename, const RenderOpts& opts)
{
    ...
    auto elapsed_time = (tbb::tick_count::now() - start).seconds();
...
main(int argc, char *argv[])
{
    ...
    try {
        ...
        if (grid) {
            ...
            {
                std::cout << "\n--------------------------------" << std::endl;
                std::cout << "Render float grid" << std::endl;
                // Render float grid
                printData<openvdb::FloatGrid>(*grid);
                double float_grid_render_time = render<openvdb::FloatGrid>(*grid, imgFilename, opts);
                std::cout << "--------------------------------" << std::endl;
            }
            {
                // Render half grid
                ...
                std::cout << "\n--------------------------------" << std::endl;
                std::cout << "Render half grid" << std::endl;
                double half_grid_render_time = render<openvdb::HalfGrid>(*hg, imgFilenameHalf, opts);
                std::cout << "--------------------------------" << std::endl;
            }
        }
