# Download and install CUDA on windows. Based off the scripts by:
...
echo "CUDA PATCH = ($CUDA_PATCH)"
echo "Matches major = ($Matches.major)"
echo "Matches minor = ($Matches.minor)"
echo "Matches patch = ($Matches.patch)"
